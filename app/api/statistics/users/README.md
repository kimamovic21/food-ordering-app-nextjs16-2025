# API Route: /api/statistics/users

> Enhanced route documentation. Keep this file aligned with the adjacent `route.ts` when behavior changes.

## Source And Ownership

- Source file: `app/api/statistics/users/route.ts`
...
Open this file when someone asks what `/api/statistics/users` does. Explain that it belongs to the statistics workflow, serves `super admin`, `admin`, validates the inputs and access rules above, then returns a stable JSON response or a clear error status.
