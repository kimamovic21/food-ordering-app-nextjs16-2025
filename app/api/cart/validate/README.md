# API Route: /api/cart/validate

> Enhanced route documentation. Keep this file aligned with the adjacent `route.ts` when behavior changes.

## Source And Ownership

- Source file: `app/api/cart/validate/route.ts`
- Route: `/api/cart/validate`
- HTTP methods: `POST`
- Feature area: cart validation
...
- Common response fields detected: `req`, `canCheckout`, `items`, `message`, `deliveryLatitude`, `deliveryLongitude`, `includeCourierReadiness`, `restaurant`
