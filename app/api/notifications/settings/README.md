...
- Source file: `app/api/notifications/settings/route.ts`
...
- Common response fields detected: `error`, `notificationSoundEnabled`, `request`, `success`

## How To Explain This In A Presentation

Open this file when someone asks what `/api/notifications/settings` does. Explain that it belongs to the notifications and realtime refresh workflow, serves `signed-in customer`, `admin`, `courier`, validates the inputs and access rules above, then returns a stable JSON response or a clear error status.
