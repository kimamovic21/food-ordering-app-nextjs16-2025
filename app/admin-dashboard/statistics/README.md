# App Folder: app/admin-dashboard/statistics

> Enhanced folder documentation. Keep this file aligned with the folder workflow when behavior changes.

## Purpose

This folder owns admin-facing UI for `/admin-dashboard/statistics`, including restaurant operations, platform management, and protected dashboard workflows.

## Route And Audience

- App route/group: `/admin-dashboard/statistics`
- Folder path: `app/admin-dashboard/statistics`
...
- This folder talks to `/api/statistics`, `/api/statistics/orders`, `/api/statistics/users`. Keep API response shapes aligned.

## Important Files

- `app/admin-dashboard/statistics/layout.tsx`: functions/components: `AdminStatisticsLayout`
- `app/admin-dashboard/statistics/loading.tsx`: functions/components: `StatisticsLoading`; client component
- `app/admin-dashboard/statistics/orders/layout.tsx`: functions/components: `AdminOrderStatisticsLayout`
- `app/admin-dashboard/statistics/orders/loading.tsx`: functions/components: `OrdersStatisticsLoading`; client component
- `app/admin-dashboard/statistics/orders/page.tsx`: functions/components: `formatCurrency`, `formatPercent`, `OrdersStatisticsPage`, `fetchStatistics`; API calls: `/api/statistics/orders`; client component
- `app/admin-dashboard/statistics/page.tsx`: functions/components: `formatCurrency`, `formatPercent`, `StatisticsPage`, `fetchStatistics`; API calls: `/api/statistics`; client component
...
If someone asks what this folder does, say: this is the `admin`, `super admin` UI for `/admin-dashboard/statistics`; it coordinates the files above, protects the edge cases listed here, and delegates server-authoritative checks to the API routes/helpers instead of trusting only the browser.
