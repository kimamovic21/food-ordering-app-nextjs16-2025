...
- App route/group: `/notifications`
- Folder path: `app/notifications`
...
- `app/notifications/loading.tsx`: functions/components: `NotificationsLoading`; client component
- `app/notifications/page.tsx`: functions/components: `NotificationsPage`; session-aware
