# App Folder: app/my-orders/[id]/courier/[courierId]
...
- App route/group: `/my-orders/[id]/courier/[courierId]`
- Folder path: `app/my-orders/[id]/courier/[courierId]`
...
If someone asks what this folder does, say: this is the `customer` UI for `/my-orders/[id]/courier/[courierId]`; it coordinates the files above, protects the edge cases listed here, and delegates server-authoritative checks to the API routes/helpers instead of trusting only the browser.
