# App Folder: app/my-deliveries/[id]
...
- App route/group: `/my-deliveries/[id]`
- Folder path: `app/my-deliveries/[id]`
...
If someone asks what this folder does, say: this is the `courier` UI for `/my-deliveries/[id]`; it coordinates the files above, protects the edge cases listed here, and delegates server-authoritative checks to the API routes/helpers instead of trusting only the browser.
