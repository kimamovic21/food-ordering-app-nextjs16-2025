# App Folder: app/messages/settings
...
- App route/group: `/messages/settings`
- Folder path: `app/messages/settings`
...
If someone asks what this folder does, say: this is the `signed-in customer`, `admin`, `courier` UI for `/messages/settings`; it coordinates the files above, protects the edge cases listed here, and delegates server-authoritative checks to the API routes/helpers instead of trusting only the browser.
